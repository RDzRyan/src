...
void chatterCallback(const nav_msgs::Odometryr& odom)
{
  ...
  ROS_INFO("%s, %f, %f, %f, %f, %f,", waktu,gerak_.pose.pose.position.x,gerak_.pose.pose.position.y,gerak_.pose.pose.position.z,gerak_.pose.pose.orientation.z,gerak_.pose.pose.orientation.w);
}
